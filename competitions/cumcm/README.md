...
| 当前规则 | 2026 规则/格式 + 2026 AI 试行规定; 见 `current_rules.md` |
...
- 使用 AI 时，参考文献前设置 AI工具使用声明，支撑材料提供 `AI工具使用详情.pdf`。
- 明确未使用 AI 时，不生成详情 PDF；同样在参考文献前声明。旧版 2025 的声明位置不能沿用。
